...
class CnnScanTests(unittest.TestCase):
    ...
    def test_navbar_has_polished_selected_motion(self):
        ...
        self.assertIn("border-radius: var(--nav-shell-radius)", style)
        self.assertIn("border-radius: var(--nav-indicator-radius)", style)
        self.assertIn("inset 0 0 0 1px rgba(61,106,75,0.08)", style)
        ...
        self.assertNotIn("nav-indicator::after", style)
