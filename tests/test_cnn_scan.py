...
class CnnScanTests(unittest.TestCase):
    ...
    def test_navbar_has_polished_selected_motion(self):
        ...
        self.assertIn("--nav-lift: 8px", style)
        self.assertIn("--nav-bulge-active: 8px", style)
        self.assertIn("--nav-indicator-window-width: 48px", style)
        self.assertIn("--nav-indicator-window-height: 34px", style)
        self.assertIn("--nav-indicator-hold-width: 68px", style)
        self.assertIn("--nav-indicator-hold-height: 40px", style)
        ...
        self.assertIn("const yLimit = mesh.height - 0.5;", app)
