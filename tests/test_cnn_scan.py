...
class CnnScanTests(unittest.TestCase):
    ...
    def test_navbar_has_polished_selected_motion(self):
        ...
        self.assertIn("--nav-shell-edge-inset: 5px", style)
        ...
        self.assertIn("getCssPx('--nav-shell-edge-inset', 5)", app)
        ...
        self.assertIn("const xMin = edgeInset - horizontalBleed;", app)
        self.assertIn("const xLimit = mesh.width - edgeInset + horizontalBleed;", app)
