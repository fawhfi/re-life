...
class CnnScanTests(unittest.TestCase):
    ...
    def test_navbar_has_polished_selected_motion(self):
        ...
        self.assertIn("--nav-shell-radius: 28px", style)
        self.assertIn("--nav-indicator-inset: 5px", style)
        self.assertIn("--nav-arch: 13px", style)
        self.assertIn("--nav-lift: 12px", style)
        self.assertIn("--nav-indicator-window-width: 44px", style)
        self.assertIn("--nav-indicator-window-height: 32px", style)
        self.assertIn("--nav-indicator-hold-width: 76px", style)
        self.assertIn("--nav-indicator-hold-height: 44px", style)
        ...
        self.assertIn(".nav-is-holding .nav-indicator::after", style)
        self.assertIn("border-radius: calc(var(--nav-indicator-window-height) / 2)", style)
        self.assertIn("border-radius: calc(var(--nav-indicator-hold-height) / 2)", style)
        self.assertIn("function generateNavShellPath", app)
        self.assertIn("function drawNavShell", app)
        self.assertIn("liquidShell.setBulge(13);", app)
